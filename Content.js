...
var _this = this;
var excludedRedditPathnames = ["media", "gallery"];
window.onload = function () { return __awaiter(_this, void 0, void 0, function () {
    var pathname, protocol, host, search, modifiedURL;
    return __generator(this, function (_a) {
        ...
        if (host.includes("www")) {
            if (!pathname.includes("media") && !pathname.includes("gallery")) {
                modifiedURL = "".concat(protocol, "//").concat(host.replace("www", "old")).concat(pathname).concat(search);
...
function clickContinueButton() {
    ...
    buttons.forEach(function (button) {
        var valueAttribute = button.getAttribute("value");
